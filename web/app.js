...
function renderPrices(){
  ...
  el.innerHTML='<div class="table-wrap"><table><thead><tr>'+head.map(function(h){return '<th>'+h+'</th>';}).join('')+'</tr></thead><tbody>'+
    ...
    '<div style="font-size:11px;color:var(--muted);margin-top:6px">* «Просто торты» (готовые целые в наличии): у Марии — реальные цены продаж из 1С (чеки 05.05–04.06.2026, 46 позиций). Конкуренты готовые торты онлайн не публикуют — их сайты только про заказные/бенто, у ЯХОНТа сайта нет. Готовый торт «здесь и сейчас» — формат, в котором онлайн-сравнения у Марии нет.</div>';
}
